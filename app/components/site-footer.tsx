...
export function SiteFooter() {
  ...
  return (
    <footer
      id="contact"
      className="paper-nav scroll-mt-28 flex min-h-[22svh] items-center"
    >
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 md:px-10 md:py-9 xl:px-12">
        <div className="grid gap-5 lg:grid-cols-3 lg:items-start">
          <div className="flex flex-col items-center justify-start gap-2 text-center lg:items-start lg:text-left">
            <p className="section-readable text-lg font-black tracking-tight text-[#0F172A]">
              ...
              <span className="text-[#075985]">{content.brand.accent}</span>
            </p>
          ...
          <div className="flex flex-col items-center justify-start gap-2 text-center">
            <p className="section-readable text-sm font-bold uppercase tracking-[0.2em] text-[#075985]">
            ...
            >
              <Mail className="h-5 w-5 shrink-0 text-[#075985]" aria-hidden="true" />
