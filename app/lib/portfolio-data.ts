...
export const techGroups: TechGroup[] = [
  ...
  },
  {
    ...
    tools: [
      { name: "Solidity", logo: "/logos/solidity-original.svg" },
      { name: "Move", logo: "/logo-move.svg" },
      { name: "Rust", logo: "/logos/rust-original.svg" },
      { name: "Go", logo: "/logos/go-original-wordmark.svg" },
      { name: "Python", logo: "/logos/python-original.svg" },
      { name: "PHP", logo: "/logos/php-777BB4.svg" },
    ],
  },
  {
    ...
    tools: [
      ...
      { name: "Tailwind CSS", logo: "/logos/tailwindcss-06B6D4.svg" },
      { name: "Vite", logo: "/logos/vite-646CFF.svg" },
      { name: "Blade", logo: "/logos/laravel-FF2D20.svg" },
    ],
  },
  {
  ...
  },
  {
    ...
    tools: [
      { name: "Hardhat", logo: "/logos/hardhat-original.svg" },
      { name: "Foundry", logo: "/logos/foundry.webp" },
    ],
  },
  {
    title: "Design & Collaboration",
    tools: [
      { name: "Figma", logo: "/logos/figma-F24E1E.svg" },
      { name: "Trello", logo: "/logos/trello-0052CC.svg" },
    ],
  },
  {
  ...
  },
  {
    ...
    tools: [
      { name: "Google Analytics 4", logo: "/logos/googleanalytics-E37400.svg" },
  ...
  },
  {
    ...
    tools: [
      { name: "Digiflazz", logo: "/logo-digiflazz.webp" },
